...
import { getPartneredTours } from "../../../Services/tourService/tourService";
...
function usePartnerCard({ onSuccess, onError } = {}) {
  const { data = [], isPending, error } = useQuery({
    queryKey: ["partnered-tours"],
    queryFn: getPartneredTours,
